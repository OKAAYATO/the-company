                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                                <i class="fa-regular fa-user text-secondary d-block text-center dashboard-icon"></i>
                            <?php
                                }
                                ?>
                            </td>
                            ...
                            <td>
                                ...
                                ?>
                                    ...
                                    <a href="delete-user.php" class="btn btn-outline-danger" title="Delete"><i class="fa-solid fa-trash"></i></a>
                                <?php
                                }
                                ?>
                            </td>
